...
import { generateDemoDailyReports, generateDemoMonthlyReports, generateDemoCompetitorData } from './utils/constants'
...
class App extends React.Component {
  componentDidMount() {
    ...
    try {
      ...
      console.log('[App] Demo data generated on mount')
    } catch (e) {
